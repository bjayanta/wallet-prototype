...
/**
 * Created by Jayanta Biswas on 8/23/2017.
 *
 * For Exchange part
 *
 */

public class ExchangeRestOperation {
     ...
     * @param key
     */
    public ExchangeRestOperation(String url, String key) {
        this.apiURL = url;
        this.apiKey = key;
    }
    ...
    private String getResponse(String method, String segment, String data) {
        ...
        // set default url
        String apiurl = apiURL + "exchangeapi/" + segment;
